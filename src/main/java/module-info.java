module com.example.kursinis {
    ...
    opens com.example.kursinis.model.Trip to com.fasterxml.jackson.databind, javafx.graphics, javafx.fxml, javafx.base;
    ...
    opens com.example.kursinis.model to javafx.fxml, javafx.base;
